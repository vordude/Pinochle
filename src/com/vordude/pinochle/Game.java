...
public class Game extends Activity {
    ...
    public void dealShortcut(View v) {
        ...
        Meld meldSouth = new Meld(south, Suit.SPADES);
        Log.w("Score", Integer.toString(meldSouth.getMeldScore()));

        Log.w("Score", "End of Hand");
        aiPlay(dealtHands);
    }
